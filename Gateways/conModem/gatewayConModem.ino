...
PROBLEMA 1:
ESTA VERSION PIERDE MUCHOS MENSAJES, HAY QUE MEJORARLA SACANDO EL PROCESAMIENTO DE LOS MENSAJES DEL CALLBACK DE ESP_NOW,
Y HACIENDO QUE EL CALLBACK SOLO GUARDE LOS MENSAJES EN UNA COLA, Y LUEGO PROCESAR LA COLA EN EL LOOP PRINCIPAL.

La solución ya está implentada, este queda como trabajo para los alumnos.

PROBLEMA 2
También hay que hacer que se conecte a MQTT con un nombre único (mac) porqu si hay varios modems con el mismo nombre uno tira la conexión de los otros
